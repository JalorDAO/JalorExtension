...
function getScatterJS(stream) {
	let holder = new Proxy(new Holder(new Index(stream)), {
		get(target,name) {
...
export {Plugin, PluginTypes, Blockchains, Network, SocketService, EVENTS, WalletInterface, WALLET_METHODS,getScatterJS};
// export default getScatterJS;
