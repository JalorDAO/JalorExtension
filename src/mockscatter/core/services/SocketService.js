...
const sha256 = (data) => {
	return Hasher.insecureHash(data);
}

const random = () => {
    return IdGenerator.numeric(24);
};
...
export default class SocketService {
    ...
    constructor(_stream, _plugin, _timeout){
	    this.plugin = _plugin;
    ...
    sendApiRequest(request){
		return new Promise((resolve, reject) => {
			...
			let message = new NetworkMessage(request.type, request.payload, id);
