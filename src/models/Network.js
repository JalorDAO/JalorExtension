import {Blockchains,getChainType} from './Blockchains';

export default class Network {
    constructor(_name = '', _protocol = 'https', _host = '', _port = 443, blockchain = Blockchains.EOS, chainId = ''){
        this.name = _name;
        ...
        this.chainType = getChainType(blockchain);
    }
