...
export default class ETH extends Plugin {
    ...
    constructor(){ super(Blockchains.ETH, PluginTypes.ETHEREUM) }
    ...
    /* publicToAddress(publicKey){
        return ethUtil.addHexPrefix(ethUtil.publicToAddress(toBuffer(publicKey)).toString('hex'));
    } */
    privateToPublic(privateKey){ 
        return ethUtil.addHexPrefix(ethUtil.privateToAddress(toBuffer(privateKey)).toString('hex')); 
        // return ethUtil.privateToPublic(toBuffer(privateKey)).toString('hex')
    }
    ...
    async mnemonicToPrivate(MnemonicStr){
        ...
        return ethUtil.addHexPrefix(privateKey.toString('hex'))
    }
    convertsTo(){
