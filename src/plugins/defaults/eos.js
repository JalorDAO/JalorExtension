...
export default class EOS extends Plugin {
    ...
    constructor() { super(Blockchains.EOS, PluginTypes.EOSIO) }
    ...
    getTestnets() {
        return [
            // new Network('Kylin Testnet', 'https', 'api-kylin.eosasia.one', 443, Blockchains.EOS, '5fff1dae8dc8e2fc4d5b23b2c7665c97f9e9d8edf2b6485a86ba311c25639191'),
            new Network(
                'YAS Mainnet', 'https',
                'rpc.yas.plus',
                443,
                Blockchains.EOS,
                'ed8636abfe625d99fc9a759d49a016fd8dcae9193676a020aae2540c9fffe32f'
            )
        ]
    }
    ...
    signatureProvider(...args) {
        ...
        return (network, _eos, _options = {}, protocol = 'http') => {
            ...
            const httpEndpoint = network.httpEndpoint ? network.httpEndpoint : `${network.protocol}://${network.hostport()}`;
            ...
            return proxy(_eos({ httpEndpoint, chainId }), {
                get(eosInstance, method) {
                    ...
                    if (typeof eosInstance[method] !== 'function') return eosInstance[method];
                    ...
                    return (...args) => {
                        ...
                        const signProvider = async signargs => {
                            ...
                            // Friendly formatting
                            signargs.messages = await requestParser(_eos, signargs, httpEndpoint, args[0], chainId);
