...
export default class ENU extends Plugin {
    ...
    constructor() { super(Blockchains.ENU, PluginTypes.EOSIO) }
    ...
    privateToPublic(privateKey) { return ecc.privateToPublic(privateKey, "ENU"); }
    validPrivateKey(privateKey) { return ecc.isValidPrivate(privateKey); }
    validPublicKey(publicKey) { return ecc.isValidPublic(publicKey, "ENU"); }
