    ...
    <section>
        ...
        <section v-if="step == 0">
            <section class="white-bg">
                <figure class="title">{{locale(langKeys.REQUEST_Welcome)[0]}}</figure>
                <figure class="breaker"></figure>
                <figure class="description">
                    {{locale(langKeys.REQUEST_Welcome)[1]}}
                    <br><br>
                    {{locale(langKeys.REQUEST_Welcome)[2]}}
                </figure>
            </section>
            <section class="p20">
                ...
                <btn :text="locale(langKeys.GENERIC_Confirm)" :is-red="true" v-on:clicked="finished" margined="true"></btn> 
            </section>
        </section>
        ...
        <!-- <section v-if="step == 1">
            <section class="white-bg">
                ...
                <figure class="breaker"></figure>
                <figure class="description">
                    Jalor supports multiple blockchains. When you enter your Key Pair we will determine which
        ...
        <section v-if="step == 2">
            <section class="white-bg">
                ...
                <figure class="breaker"></figure>
                <figure class="description">
                    You now have a Jalor Identity with an {{keypair.blockchain.toUpperCase()}} account linked to it.
                    <br><br>
