        ...
        <section class="p20 scroller with-search">
            <section v-for="network in filterBySearch()" class="panel-box">
                ...
                <section class="panel">
                    ...
                    <figure class="header small margin"><i class="fa fa-chain"></i>{{network.port}}</figure>
                </section>
                ...
                <section class="panel">
                    <section class="actions">
                        <figure class="action blue" v-on:click="editNetwork(network)"><i class="fa fa-edit"></i></figure>
                        <figure class="action red right" v-on:click="deleteNetwork(network)"><i class="fa fa-trash"></i></figure>
                    </section>
                </section>
    ...
    export default {
        ...
        methods: {
            ...
            async editNetwork(network){
                this.$router.push({ name:RouteNames.NETWORK, query: { network: JSON.stringify(network) } })
            },
            ...mapActions([
