...
import ExportPrivateView from '../views/ExportPrivateView.vue'
...
const RouteViews = {
    ...
    [RouteNames.QRCODE]:QrcodeView,
    [RouteNames.EXPORT]:ExportPrivateView,
...
export const RouteDepth = {
    ...
    [RouteNames.EXPORT]:101,
    [RouteNames.QRCODE]:101,
};
