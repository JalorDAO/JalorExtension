...
export const GENERIC_Scan_Identity = 'gen_sid';
export const GENERIC_Input_Identity = 'gen_iid';
...
export const GENERIC_Import_key = 'gen_import_key';
export const GENERIC_No_key = 'gen_no_key';
...
export const GENERIC_Done = 'gen_done';
export const GENERIC_Type = 'gen_type';
...
export const BUTTON_AssociateAccount = 'btn_associate_acc';
...
export const BUTTON_ExportPrivate = 'btn_export_priv';
export const BUTTON_SkipExportPrivate = 'btn_skip_export_priv';
...
export const SETTINGSMENU_Networks = 'sm_nets';
export const SETTINGSMENU_Network = 'sm_net';
...
export const SETTINGSMENU_Qrcode = 'sm_qrcode';
export const SETTINGSMENU_ExportPrivate = 'sm_export_private';
...
export const BACKUP_Key_Description = 'backup_key_desc';
...
export const ALERT_InvalidMnemonic = 'alert_inv_mnem';
...
export const PROMPT_ConfirmCopy = 'prompt_confirm_copy'
...
export const REQUEST_Welcome = 'req_welcome';
export const GENERIC_Confirm = 'gen_confirm';
export const BUTTON_WroteDownMnemonic = 'btn_wrote_down'
export const MAINMENU_Settings = 'mm_settings'
