...
export default {
    ...
    [KEYS.GENERIC_Identity]:`Import Account`,
    [KEYS.GENERIC_Scan_Identity]:`Scan Account`,
    [KEYS.GENERIC_Input_Identity]:`Input Account`,
    ...
    [KEYS.GENERIC_Import_key]:'Import Key',
    [KEYS.GENERIC_No_key]:'Have\'t imported key?',
    [KEYS.GENERIC_ChainID]:'Chain ID',
    [KEYS.GENERIC_Blockchain]:'Blockchain',
    [KEYS.GENERIC_Account]:'Account',
    [KEYS.GENERIC_Confirm]:'Confirm',
    [KEYS.GENERIC_Done]:'Done',
    [KEYS.GENERIC_Type]:'Type',
    ...
    [KEYS.BUTTON_AssociateAccount]:'Associate Account',
    ...
    [KEYS.BUTTON_DestroyScatter]:'Destroy Jalor ',
    [KEYS.BUTTON_CreateNewScatter]:'Create New Jalor ',
    [KEYS.BUTTON_LoadFromBackup]:'Load From Backup',
    [KEYS.BUTTON_Unlock]:'Unlock',
    [KEYS.BUTTON_ExportScatter]:'Export Jalor ',
    [KEYS.BUTTON_ExportPrivate]:'Backup Private Key',
    [KEYS.BUTTON_SkipExportPrivate]:'Skip Backup',
    ...
    [KEYS.BUTTON_SelectIdentity]:'Select Account',
    [KEYS.BUTTON_ChangeName]:'Change Name',
    [KEYS.BUTTON_ClaimIdentity]:'Claim Identity',
    [KEYS.BUTTON_RegisterIdentity]:'Register Identity',
    [KEYS.BUTTON_WroteDownMnemonic]:'I wrote it down',

    [KEYS.MAINMENU_Identities]:'Accounts',
    [KEYS.MAINMENU_Keys]:'Key Pairs',
    [KEYS.MAINMENU_Permissions]:'Permissions',
    [KEYS.MAINMENU_History]:'History',
    [KEYS.MAINMENU_Lock]:'Lock',
    [KEYS.MAINMENU_Settings]:'Settings',

    [KEYS.IDENTITIES_Header]:`You are not currently associated with an account.`,
    [KEYS.IDENTITIES_Description]:`
        The blockchain address or account associated with your key pair.
    `,
    ...
    `,
    [KEYS.PERMISSION_RevokeIdentity]:`Revoke Permission`,
    ...
    [KEYS.HISTORIES_Description]:`
        Once you have them, you will be able to see a list of all of the events that pass through your Jalor.
        What you will not see is events that occurred on your accounts outside of scatter.
     `,
    [KEYS.HISTORIES_Note]:`
        Note: Exporting your Jalor data from the backup option in the settings panel does not save these events.
        When you import that Jalor instance again your histories will be empty. If you would like to export your histories
        in the future you can do so using the action buttons on the navbar within this panel.
    `,

    [KEYS.SETTINGSMENU_Networks]:'Networks',
    [KEYS.SETTINGSMENU_Network]:'Network',
    [KEYS.SETTINGSMENU_Keypairs]:'Key Pairs',
    [KEYS.SETTINGSMENU_Qrcode]:'Qrcode',
    [KEYS.SETTINGSMENU_ExportPrivate]:'Backup Private Key',
    ...
    [KEYS.BACKUP_Description]:`
        Exporting your Jalor allows you to import it into other devices. The file will still be encrypted when it is 
        exported so make sure you have either your mnemonic or your password, otherwise it will be useless. 
    `,
    [KEYS.BACKUP_Key_Description]:`
        Don’t use network to transfer your keys, it’s a good idea to write down and backup your keys,
        Screenshots and copying have unknown risks. You can also scan the QR code to transfer keys to your other deivce.
    `,
    [KEYS.IMPORT_Header]:`Import encrypted backup`,
    [KEYS.IMPORT_Description]:`
        Importing your encrypted keychain file will rebuild you Jalor keychain but it will not import your old networks or 
        accounts. 
    `,
    ...
    [KEYS.DESTROY_Header]:`Destroying Jalor`,
    [KEYS.DESTROY_Description]:`
        You are about to destroy your entire Jalor keychain. The only way to get this exact Jalor back is by 
        importing an exported Jalor JSON. You will not be able to claim your identities otherwise. Make sure you 
        have exported your Jalor from the backup settings panel before hand.
    `,
    ...
    `,
    [KEYS.KEYPAIR_Important]:`Save your private key elsewhere! You can not take private keys back out of Jalor.`,
    ...
    [KEYS.LOCK_Description]:`
        Auto Lock handles Jalor's locking for you so that you don't have to 
        remember to lock your Jalor when you step away.
    `,
    ...
    [KEYS.MNEMONIC_Description]:`Mnemonics in Jalor are only used for password recovery.`,
    [KEYS.MNEMONIC_Note]:`
        Be sure to save yours somewhere safe. It is the only way to regain access to your 
        Jalor and decrypt your private information if you forget your password.
    `,
    ...
    [KEYS.ALERT_InvalidMnemonic]:[
        'Invalid Mnemonic Key',

        `The mnemonic you entered seems to be invalid. Please check the mnemonic and try again.`
    ],
    //2
    ...
    [KEYS.ALERT_RemovingEndorsedNetwork]:[
        ...
        `You cannot remove Jalor's endorsed Networks.`
    ],
    //2
    ...
    [KEYS.PROMPT_RevokingIdentity]:domain => [
        ...
        `You are about to revoke an entire Permission from ${domain}. This will remove 
    ...
    [KEYS.PROMPT_RemovingIdentity]:name => [
        ...
        `You are about to remove an Account with the name '${name}'. Removing Account is not reversible and
    ...
    [KEYS.REQUEST_AddNetwork]:[
        /*{DOMAIN}*/ 'wants to add their network to your Jalor.',

        'Some applications use their own Networks.',

        `This in no way gives the application any access to your Jalor. 
    ...
    [KEYS.REQUEST_ScatterIsLocked]:[
        `Your Jalor is locked!`,

        `Before you can do anything with your Jalor you will need to unlock it.`,
        ...
        `If you see a prompt/popup which is requesting your password, it is a malicious website trying to get your password.
         Always only unlock Jalor from the extension's popup by clicking on the icon in your browser tray.`
    ],
    //4
    [KEYS.REQUEST_UpdateVersion]:[
        `Your Jalor is out of date!`,

        /*{DOMAIN}*/ `is requiring you have a version of Jalor that is newer than the one installed.`,
        ...
        `Please Note, we leave version checking up to the applications themselves. They could be maliciously trying to
         get you to download something. Make sure you always download Jalor from the proper location.`
    ],
    [KEYS.REQUEST_Welcome]:[
        `Welcome to Jalor!`,
        `The Jalor team holds no liability towards your digital assets. It is your responsibility to constantly make sure your
        computer is free of malware. We have taken every measure in our capabilities to ensure that Jalor is safe to use
        as intended however your computer itself is your worst enemy and should be treated as such.`,
        `By using Jalor you are relinquishing any ability to take legal actions against the Jalor team
        and recognize yourself as the sole legal owner of your own Jalor instance, your keys, and your data.`
    ]
